...
class _DenseLayer(nn.Module):
    def __init__(self, num_input_features, growth_rate, bn_size, drop_rate, efficient=False):
        ...
        self.add_module('conv1', nn.Conv2d(num_input_features, bn_size * abs(growth_rate),
                        kernel_size=1, stride=1, bias=False)),
        self.add_module('norm2', nn.BatchNorm2d(bn_size * abs(growth_rate))),
        self.add_module('relu2', nn.ReLU(inplace=True)),
        self.add_module('conv2', nn.Conv2d(bn_size * abs(growth_rate), abs(growth_rate),
