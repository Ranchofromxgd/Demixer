...
class Config:
    ...
    channels = 2
    OUTPUT_MASK = True
    model_name = "Unet"  # "demucs" "Unet" #"Demixer" "DenseUnet"
    '''
    dense_block = 5
        dense_bn = 6
        dense_layers = 3
    ...
    if (model_name == "DenseUnet"):
        ...
        model_name_alias = "Demucs"
    elif (model_name == "MbandUnet"):
        model_name_alias = "MbandUnet"
    ...
    load_model_path = project_root + "saved_models/1_2020_4_18__unet_spleeter_spleeter_sf112000_l1_l2_l3_lr001_bs4-1_fl3_ss64000_9lnu5mu0.5sig0.2low0.3hig0.5fshift8flength32drop0split_bandTrue_4"
    start_point = 0
    ...
    if (OUTPUT_MASK == False):
        trail_name = str(cur.year) + "_" + str(cur.month) + "_" + str(
            cur.day) + "_" + model_name_alias + '_NM_spleeter_'
    else:
        trail_name = str(cur.year) + "_" + str(cur.month) + "_" + str(
            cur.day) + "_" + model_name_alias + 'spleeter_' + "sf" + str(start_point) + "_"
    counter = 1
    ...
    #     # # datahub_root + "datahub/VCTK.txt", # 1440
    #     # datahub_root + "datahub/song_vocal_data_44_1.txt",  # 1440
    #     # datahub_root + "datahub/song_vocal_data_44_1.txt", # 1440
    #     # datahub_root + "datahub/song_vocal_data_44_1.txt", # 1440
    #     # datahub_root + "datahub/song_vocal_data_44_1.txt", # 1440
