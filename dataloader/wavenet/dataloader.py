...
class WavenetDataloader(Dataset):
    def __init__(self,sample_length = Config.sample_rate*Config.frame_length,empty_every_n = 2):
    ...
    def __getitem__(self, item):
        ...
        return mixed_crop,vocal_crop,mixed_crop+vocal_crop #,(music_fname.split("/")[-2],vocal_fname.split("/")[-2])
